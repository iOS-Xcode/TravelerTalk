...
//  everybodyChats
//
//  Created by seokhyun kim on 2017-08-04.
...
class LoginController: UIViewController {
    ...
    lazy var profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "programming.jpg")
    ...
    func setupLoginRegisterButton() {
        ...
        loginRegisterButton.heightAnchor.constraint(lessThanOrEqualToConstant: 50).isActive = true
